module Blend2D::Styling
  class Gradient < Core(LibBlend2D::BLGradientCore)
    ...
    def self.linear(x0 : Float64, y0 : Float64, x1 : Float64, y1 : Float64, extend_mode : ExtendMode = ExtendMode::Pad) : Gradient
      new Linear.new(x0, y0, x1, y1), extend_mode
    end

    def self.radial(x0 : Float64, y0 : Float64, x1 : Float64, y1 : Float64, r0 : Float64, extend_mode : ExtendMode = ExtendMode::Pad) : Gradient
      new Radial.new(x0, y0, x1, y1, r0), extend_mode
    end

    def self.conic(x0 : Float64, y0 : Float64, angle : Float64, extend_mode : ExtendMode = ExtendMode::Pad) : Gradient
