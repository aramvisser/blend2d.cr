module Blend2D
  class Gradient
    ...
    # :nodoc:
    def initialize(type : GradientType, values : Pointer, extendMode : ExtendMode, stops : LibBlend2D::BLGradientStop*, n : Int32, transform : LibBlend2D::BLMatrix2D*)
    ...
    # :nodoc:
    def assign_move(other : Gradient) : Bool
      LibBlend2D.blGradientAssignMove(self, other).success_or_raise
    end

    # :nodoc:
    def assign_weak(other : Gradient) : Bool
      LibBlend2D.blGradientAssignWeak(self, other).success_or_raise
    end

    # :nodoc:
    def create(type : GradientType, values : Pointer, extendMode : ExtendMode, stops : LibBlend2D::BLGradientStop*, n : Int32, transform : LibBlend2D::BLMatrix2D*) : Bool
    ...
    # :nodoc:
    def self.equals(a : Gradient, b : Gradient) : Int32
