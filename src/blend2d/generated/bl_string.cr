module Blend2D
  class BLString
    ...
    # :nodoc:
    def initialize(str : UInt8*, size : Int32)
    ...
    # :nodoc:
    def self.equals(a : String, b : String) : Int32
      LibBlend2D.blStringEquals(a, b)
    end

    # :nodoc:
    def equals_data(str : UInt8*, n : Int32) : Int32
    ...
    # :nodoc:
    def compare_data(str : UInt8*, n : Int32) : Int32
